...
while escolha == 1 or 2:
    ...
    #verifica se o valor diditado é um número
        ...
        #vai calcular a hipotenusa
            ...
            hipotenusa = (lado1 ** 2) + (lado2 ** 2)#calculo bruto
            hipotenusa = math.sqrt(hipotenusa)#retorna com a raiz calculada

            print(f"\nDado o cateto A {lado1} e cateto B {lado2} o comprimento da hipotenusa é {hipotenusa:.4f} \n")
            break
        elif int(escolha) == 2 :
        #vai calcular o cateto
            ...
            #se os dados forem corretos
                ...
                print(f"Dado o cateto A {lado1} e a hipotenusa {lado2} o comprimento do cateto B é {cateto:.4f} ")
            ...
            #casos os dados possam executar o teorema mas estejam em ordem errada
                ...
                print(f"Dado o cateto A {lado1}  e a hipotenusa {lado2} (originalmente inserido como o cateto) o comprimento do cateto B é {cateto:.4f}\n ")
                print("O calculo foi feito, porem foi considerado que o cateto A é na verdade a hipotenusa \nRecomendo revisar os dados \n ")
